...
let img=[];
let estado=0;
let creditos=['El Pijama del gato', 'Ray Bradbury','Uma Brau', 'Trinidad Gmelin']
...
function draw() {
  if (estado===0) {
    portada(img[0], creditos[0], creditos[1], width/2, 75, width/2, 125);
    ...
    fondo(img[18], 20, 200, 580, 80, 50, txt[17], 50, 100, 500, 400, 125, 60, "Creditos" );
  }
  
  else if (estado===19) {
    portada(img[19], creditos[2], creditos[3], width/2, 75, width/2, 125);
    boton( 500, 400, 125, 60, "Inicio" );
  }
  
  else if (estado===20) {
    portada(img[20], creditos[2], creditos[3], width/2, 75, width/2, 125);
    boton( 500, 400, 125, 60, "Inicio" );
  }
  
  else if (estado===21) {
    portada(img[21], creditos[2], creditos[3], width/2, 75, width/2, 125);
    boton( 500, 400, 125, 60, "Inicio" );
  }
}
